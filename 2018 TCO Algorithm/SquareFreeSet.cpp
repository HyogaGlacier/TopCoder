...
// CUT begin
ifstream data("SquareFreeSet.sample");
...
bool do_test(vector<int> x, int __expected) {
    ...
    SquareFreeSet *instance = new SquareFreeSet();
    int __result = instance->findCost(x);
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "SquareFreeSet (1000 Points)" << endl << endl;
    }
