...
struct CardCounter {
  ...
  int dealer;
  vector<int> player;
  double winningChance(vector<int> _deck, int _dealer, vector<int> _player) {
    deck = _deck, dealer = _dealer, player = _player;
    return 0.0;
  }
};

// CUT begin
ifstream data("CardCounter.sample");
